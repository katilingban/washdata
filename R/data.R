#' Population Data - Dhaka, Bangladesh
#'
...
#' WASH Survey Data - Dhaka, Bangladesh
#'
#' WASH survey data collected by WSUP in Dhaka, Bangladesh using
#'
#' @format A data frame with 218 variables:
#' \describe{
#' \item{\code{country}}{Country}
#' \item{\code{countryCode}}{Country Code}
...
#' \item{\code{slum}}{Slum}
#' \item{\code{houseIdentifiers}}{Additional house identifiers}
