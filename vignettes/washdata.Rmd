...
[^1]: Valid International, 2006. Community-based Therapeutic Care (CTC): A Field Manual, Oxford: Valid International.
[^2]: see Food and Nutrition Technical Assistance III Project (FANTA). 2018. Training Guide for Community-Based Management of Acute Malnutrition (CMAM). Washington, DC: FHI 360/FANTA
...
[^17]: The best openly available sources for this map data are from the [WorldPop project](https://www.worldpop.org) and the [Global Rural-Urban Mapping Project or GRUMP](https://www.earthdata.nasa.gov/data/catalog/sedac-ciesin-sedac-grumpv1-ext-1.00).
